...
const heroSlides: HeroSlide[] = [
  {
    ...
    title: "TriStream",
    titleHighlight: "ZK-DAG Blockchain",
    subtitle: "The First L1 With Working Tech at Presale",
    description:
      "A next-generation Proof-of-Work blockchain with high throughput through parallel execution, 100ms blocks, and ZK-proven finality. Our nodes, mining, and AI compute are already built—not roadmap items.",
