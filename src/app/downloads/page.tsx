            ...
            <div className="relative grid lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a 
                    href={`${RELEASES_BASE}/pyrax-desktop/pyrax-desktop.exe/pyrax-desktop.exe`}
                  ...
                  <a 
                    href={`${RELEASES_BASE}/pyrax-desktop/pyrax-desktop-linux.AppImage/pyrax-desktop-linux.AppImage`}
