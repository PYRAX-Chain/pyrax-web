...
const phases = [
  ...
  },
  {
    ...
    description: "Feature completeness, AI compute beta, and stress testing.",
    milestones: [
      { text: "Full GHOSTDAG implementation", done: true },
      { text: "Complete RPC API", done: true },
      { text: "Crucible AI inference beta", done: true },
  ...
  },
  {
    ...
    status: "in_development",
    description: "Stream C + ZK finality + full AI integration.",
    milestones: [
      { text: "ZK checkpoint generation", done: true },
      { text: "Foundry ML training beta", done: true },
      { text: "Prover network operational", done: true },
